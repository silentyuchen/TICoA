...
def get_args_parser():
    parser = argparse.ArgumentParser('Mamber training and evaluation script', add_help=False)
    ...
    parser.add_argument('--pretrain-path', default='/root/autodl-tmp/dataset/', type=str)
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/root/autodl-tmp/dataset/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='refcoco', choices=['refcoco', 'refcoco+', 'refcocog'],
                        type=str)

    parser.add_argument('--output_dir', default='/root/autodl-tmp/ReMamber-master/ouput',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    # parser.add_argument('--resume', default='/root/autodl-tmp/ReMamber-master/pretrain/vssm_base_0229_ckpt_epoch_237.pth', help='resume from checkpoint')
...
def main(args):
    ...
    if args.resume:
        if args.resume.startswith('https'):
            ...
            # checkpoint = torch.load(r'/root/autodl-tmp/ReMamber-master/pretrain/vssm_base_0229_ckpt_epoch_237.pth', map_location='cpu')
